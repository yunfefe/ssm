...
<body>
    ...
    <div class="fllist">
        <ul>
            <form action="/book/getbooklist" method="post">
           	<li>
            <strong>
            标题:&nbsp;&nbsp;
            </strong>
            <input type="text" name="informationname" value="${informationname}"/>&nbsp;&nbsp;<input type="submit" value="搜索" />
            </li>
            </form>
            <li><strong>类型：</strong><a href="/book/getbooklist" id="tAll" >全部</a>
                
                <a href="/book/getbooklist?typeid=1" id="1" >
                    复习资料</a>
                
                <a href="/book/getbooklist?typeid=2" id="2" >
                    练习题</a>
                
                <a href="/book/getbooklist?typeid=3" id="3" >
                    内部资料</a>
                
                <a href="/book/getbooklist?typeid=4" id="4" >
                    真题</a>
