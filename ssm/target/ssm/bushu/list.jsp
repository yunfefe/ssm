 ...
 <div class="cztable">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <c:forEach items="${deplist}" var="dep">
                <tr align="center">
                    <td>${dep.id}</td>
                    <td>${dep.name}</td>
                    <td><fmt:formatDate value="${dep.deploymentTime}" pattern="yyyy-MM-dd"></fmt:formatDate></td>
                    <td><a href="/bushu/delete?depid=${dep.id}">删除</a> </td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
     ...
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
         ...
         <tr style="height: 25px" align="center">
             ...
             <th scope="col"><a href="/bushu/lookimage?depid=${pro.deploymentId}&imagename=${pro.diagramResourceName}" >查看流程图</a></th>
         </tr>
            </c:forEach>
         </tbody>
     </table>
