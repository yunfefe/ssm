...
<div class="cztable">
	<form action="/power/menu/update" method="post">
...
<table border="1" width="100%" class="table_a">
				...
				<tr  width="120px;">
                    ...
                    <td>
                    	<select name="upmenuid">
                            ...
                            <c:forEach items="${pi.list}" var="m">
                            <option <c:if test="${menu.upmenuid==m.menuid}">selected</c:if> value="${m.menuid}">${m.menuname}</option>
                            </c:forEach>
                        </select>
					</td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="radio" name="menustate" checked value="1" <c:if test="${menu.menustate==1}">checked</c:if> />启用
                        <input type="radio" name="menustate" value="2" <c:if test="${menu.menustate==2}">checked</c:if> />禁用
                    </td>
                </tr>
