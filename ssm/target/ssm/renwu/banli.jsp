...
<div class="cztable">
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr style="height: 25px" align="center">
            ...
            <th scope="col"><textarea rows="5" disabled cols="50">${leavebill.remark}</textarea></th>
        </tr>

        <tr style="height: 25px" align="center">
            <th scope="col">批注</th>
            <th scope="col"><textarea rows="5" name="pizhu" cols="50"></textarea></th>
        </tr>
        <tr style="height: 25px" align="center">
            <th  colspan="2" scope="col">
                <c:forEach items="${names}" var="name">
                <input type="submit" name="result" value="${name}"/>
                </c:forEach>
            </th>
        </tr>
        </tbody>
...
<div class="cztable">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr style="height: 25px" align="center">
            ...
            <th scope="col">${comment.fullMessage}</th>
        </tr>
        </c:forEach>
        </tbody>
    </table>
